...
class WardsControllerTest < ActionController::TestCase
  ...
  test "should create ward" do
    assert_difference('Ward.count') do
      post :create, ward: { capacity: @ward.capacity, floor: @ward.floor, num_of_pacients: @ward.num_of_pacients, number: @ward.number }
    end
  ...
  test "should update ward" do
    patch :update, id: @ward, ward: { capacity: @ward.capacity, floor: @ward.floor, num_of_pacients: @ward.num_of_pacients, number: @ward.number }
    assert_redirected_to ward_path(assigns(:ward))
  end
